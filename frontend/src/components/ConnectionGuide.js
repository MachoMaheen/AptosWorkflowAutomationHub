  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "6px" }}>
          🔗 <strong>3. Connect Nodes:</strong> Drag from output handle ● to
          input handle ●
        </div>
        ...
        >
          <div style={{ fontSize: "11px", color: "#4a5568" }}>
            <strong>Connection Handles:</strong>
            <br />● <span style={{ color: "#ff6b6b" }}>Red</span> = Triggers
            <br />● <span style={{ color: "#4ecdc4" }}>Teal</span> = Data
            <br />● <span style={{ color: "#26de81" }}>Green</span> = Success
            <br />● <span style={{ color: "#fc5c65" }}>Red</span> = Error
          </div>
        </div>
      </div>
    </div>
